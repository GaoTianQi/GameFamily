...
@interface CategoryViewController ()<iCarouselDelegate,iCarouselDataSource>
...
-(UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    ...
    [imageView setImageWithURL:[self.tuwanVM iconURLForRowInIndexPic:index] placeholderImage:[UIImage imageNamed:@"large_image"]];
    return view;
}
...
{
    if (!_tuwanVM) {
        _tuwanVM = [[TuWanViewModel alloc] initWithType:_TuWanType.integerValue];
    }
    return _tuwanVM;
}
- (void)viewDidLoad {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.tuwanVM containImages:indexPath.row]) {
        ...
        [cell.iconIV0.imageView setImageWithURL:[self.tuwanVM iconURLSForRowInList:indexPath.row][0] placeholderImage:[UIImage imageNamed:@"noNet_"]];
        [cell.iconIV1.imageView setImageWithURL:[self.tuwanVM iconURLSForRowInList:indexPath.row][1] placeholderImage:[UIImage imageNamed:@"noNet_"]];
        [cell.iconIV2.imageView setImageWithURL:[self.tuwanVM iconURLSForRowInList:indexPath.row][2] placeholderImage:[UIImage imageNamed:@"noNet_"]];
        return cell;
    }
    ...
    [cell.iconIV.imageView setImageWithURL:[self.tuwanVM iconURLForRowInList:indexPath.row] placeholderImage:[UIImage imageNamed:@"noNet_"]];
    cell.titleLb.text = [self.tuwanVM titleForRowInList:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.tuwanVM isHtmlInListForRow:indexPath.row]) {
        [[DataPersistence defaultDataPersistence] writeToLibraryOfName:[self.tuwanVM titleForRowInList:indexPath.row] contents:[self.tuwanVM detailHtmlForRowInList:indexPath.row]];
    ...
    if ([self.tuwanVM isPicInListForRow:indexPath.row]) {
        [[DataPersistence defaultDataPersistence] writeToLibraryOfName:[self.tuwanVM titleForRowInList:indexPath.row] contents:[self.tuwanVM aidInListForRow:indexPath.row]];
