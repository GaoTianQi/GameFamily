...
- (NSString *)detailHtmlForRowInList:(NSInteger)row
{
    return [self modelForArr:self.dataArr row:row].html5;
}
...
- (NSString *)detailHtmlInIndexPic:(NSInteger)row
{
    return [self modelForArr:self.indexPicArr row:row].html5;
}
